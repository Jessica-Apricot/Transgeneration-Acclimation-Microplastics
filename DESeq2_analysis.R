...
write.csv(as.data.frame(Br_res_s_HD), file = "Significant genes/Br_res_s_HD.csv")
write.csv(as.data.frame(Br_res_s_LD), file = "Significant genes/Br_res_s_LD.csv")
write.csv(as.data.frame(Br_res_s_HL), file = "Significant genes/Br_res_s_HL.csv")
write.csv(as.data.frame(Br_res_s_MP_DMSO), file = "Significant genes/Br_res_s_MP_DMSO.csv")
write.csv(as.data.frame(Br_res_s_MP_MPD), file = "Significant genes/Br_res_s_MP_MPD.csv")
write.csv(as.data.frame(Br_res_s_MPD_DMSO), file = "Significant genes/Br_res_s_MPD_DMSO.csv")
write.csv(as.data.frame(Br_res_s_F1), file = "Significant genes/Br_res_s_F1.csv")

write.csv(as.data.frame(Go_res_s_HD), file = "Significant genes/Go_res_s_HD.csv")
write.csv(as.data.frame(Go_res_s_LD), file = "Significant genes/Go_res_s_LD.csv")
write.csv(as.data.frame(Go_res_s_HL), file = "Significant genes/Go_res_s_HL.csv")
write.csv(as.data.frame(Go_res_s_MP_DMSO), file = "Significant genes/Go_res_s_MP_DMSO.csv")
write.csv(as.data.frame(Go_res_s_MP_MPD), file = "Significant genes/Go_res_s_MP_MPD.csv")
write.csv(as.data.frame(Go_res_s_MPD_DMSO), file = "Significant genes/Go_res_s_MPD_DMSO.csv")
write.csv(as.data.frame(Go_res_s_F1), file = "Significant genes/Go_res_s_F1.csv")

write.csv(as.data.frame(Li_res_s_HD), file = "Significant genes/Li_res_s_HD.csv")
write.csv(as.data.frame(Li_res_s_LD), file = "Significant genes/Li_res_s_LD.csv")
write.csv(as.data.frame(Li_res_s_HL), file = "Significant genes/Li_res_s_HL.csv")
write.csv(as.data.frame(Li_res_s_MP_DMSO), file = "Significant genes/Li_res_s_MP_DMSO.csv")
write.csv(as.data.frame(Li_res_s_MP_MPD), file = "Significant genes/Li_res_s_MP_MPD.csv")
write.csv(as.data.frame(Li_res_s_MPD_DMSO), file = "Significant genes/Li_res_s_MPD_DMSO.csv")
write.csv(as.data.frame(Li_res_s_F1), file = "Significant genes/Li_res_s_F1.csv")
